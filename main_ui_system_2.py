...
class BlindTrainingSystem(QtWidgets.QDialog):
    def __init__(self):
        ...
        try:
            uic.loadUi('dissignerUI_2.ui', self)
        except FileNotFoundError:
            print("❌ Error: 'dissignerUI_2.ui' file not found!")
            sys.exit()
    ...
    def start_training(self):
        ...
        front_sw = map_r.get(self.letter,self.letter)



        self.practice_thread.Select_Letter_and_show.emit(self.letter)
        self.status_label.setText(f"Watch practice video carefully... ({front_sw})")
    ...
    def handle_letter_selection(self, item):
        ...
        self.status_label.setText(f"Training Mode: {ui_text}")        #change point
