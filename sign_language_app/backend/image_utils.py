...
FEATURES_PER_FRAME = 4  # x, y coordinates per landmark (or other features)
...
def preprocess_landmarks(sequence: List[LandmarkFrame]) -> np.ndarray:
    ...
    Returns:
        ...
        Shape: (1, 50, 4) - batch_size=1, 50 frames, 4 features per frame
